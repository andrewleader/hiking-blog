...
if ( ! function_exists( 'blogslog_footer_site_info' ) ) :
	...
	function blogslog_footer_site_info() {
        ...
        $options['powered_by_text'] = esc_html__( 'All Rights Reserved | ', 'blogslog' ) . esc_html( $theme_data->get( 'Name') ) . '&nbsp;' . esc_html__( 'by', 'blogslog' ). '&nbsp;<a target="_blank" href="'. esc_url( $theme_data->get( 'AuthorURI' ) ) .'">'. esc_html( ucwords( $theme_data->get( 'Author' ) ) ) .'</a>';
